...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/src/DvdWorld/UserBundle/Resources/translations/FOSUserBundle.en.yml'), 'en', 'FOSUserBundle');
